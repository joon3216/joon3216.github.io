...
* documented on various topics and ideas in statistics and computations
* involved in analysis and modeling process conducted by senior methodologists
* initiated a development of packages in R and Python
...
* Technical
    ...
    + Git and git repositories: 
        ...
        + able to integrate dynamic badges supported by Travis CI and Codecov.io 
    ...
    + SQL: able to join tables and write subqueries
    + Python and R
        + able to utilize external packages for modeling, computations, and visualiztions
        + able to develop a simple package and upload to the archives
...
* included the following functionalities to the package:
    ...
    + smoothing out data points based on constraints and selected options
    + performing k-fold cross-validation in the smoothing process

**Modeling** (personal): credit card fraud detection

* built statistical models and provided \textcolor{linkblue}{\href{https://joon3216.github.io/projects/2019/creditcardfraud/analysis}{analysis}} of data to detect fraudulent credit card use
* expected to achieve an accuracy of 97.105% and a true positive rate of 87.204% for every 6-hour worth of transaction data with the current model and the training set
