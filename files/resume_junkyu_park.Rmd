...
\texttt{\textcolor{linkblue}{\url{https://www.linkedin.com/in/junkyujoonpark/}}}
...
* built a prototype of the program that will replace the current system used by Centre for Demography that fixes negative end-of-period populations in various regional-level population tables
...
**Statistics Canada** \hspace*{\fill} `r to_ym('2020-01-06')`  
\hspace*{\fill} Ottawa, ON

\begin{adjustwidth}{0.5cm}{}
\textbf{Methodologist} (MA-03) \hspace*{\fill} Mar 2022 - Present $\cdot$ `r to_ym('2022-04-01')`

\textbf{Methodologist} (MA-02) \hspace*{\fill} Oct 2021 - Mar 2022 $\cdot$ `r to_ym('2021-10-18', '2022-03-31')`
...
\item
 developed, and maintaining, packages written in R and Python
\end{itemize}

\textbf{Methodologist} (MA-01) \hspace*{\fill} Jan 2020 - Oct 2021 $\cdot$ `r to_ym('2020-01-06', '2021-10-18')`  
\end{adjustwidth}

<!-- **Methodologist** (MA-02) \hspace*{\fill} Oct 2021 - Present $\cdot$ `r to_ym('2021-10-18')`   -->
