...
then you should use `to_sudoku` function. `to_sudoku` is merely a wrapper function of `Sudoku`; inside `to_sudoku`, `q1_str` is converted to the same form as `q1_array`, and this will be plugged into `array` argument of `Sudoku` along with other arguments.
