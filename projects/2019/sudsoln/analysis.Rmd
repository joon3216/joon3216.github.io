...
* around 90% of sudoku puzzles with a `top95` or `hardest` difficulty are expected to be solved in about 50 attempts (trials), or `r round(model_time_50, 3)` seconds
